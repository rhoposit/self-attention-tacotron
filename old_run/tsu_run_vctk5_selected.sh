...
#$ -l h_rt=01:00:00
#$ -N vctk5_s
#$ -o /gs/hs0/tgh-20IAA/jenn/taco_exp/log/vctk5_selected.out
#$ -e /gs/hs0/tgh-20IAA/jenn/taco_exp/log/vctk5_selected.err
#$ -m e
#$ -M j.williams@ed.ac.uk
#$ -v GPU_COMPUTE_MODE=0

# Command to run:
# qsub -g tgh-20IAA tsu_run_vctk5_selected.sh
...
CHECKPOINTS=/gs/hs0/tgh-20IAA/jenn/taco_exp/checkpoints/vctk5_selected
...
python tsu_postprocess_vqcodes.py vctk5_selected
