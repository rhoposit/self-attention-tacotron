...
#$ -l h_rt=01:00:00
#$ -N vctk2_s
#$ -o /gs/hs0/tgh-20IAA/jenn/taco_exp/log/vctk2_selected.out
#$ -e /gs/hs0/tgh-20IAA/jenn/taco_exp/log/vctk2_selected.err
#$ -m e
#$ -M j.williams@ed.ac.uk
#$ -v GPU_COMPUTE_MODE=0

# Command to run:
# qsub -g tgh-20IAA tsu_run_vctk2_selected.sh
...
TARGET_DATA=/gs/hs0/tgh-20IAA/jenn/taco_exp/data/vctk_target0_selected
CHECKPOINTS=/gs/hs0/tgh-20IAA/jenn/taco_exp/checkpoints/vctk2_selected
VCTK_SELECTED_LIST=/gs/hs0/tgh-20IAA/jenn/taco_exp/self_attention_tacotron/examples/codes_spksubset
...
python tsu_postprocess_vqcodes.py vctk2_selected
