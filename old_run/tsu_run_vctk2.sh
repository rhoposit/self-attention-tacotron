...
#$ -l h_rt=00:30:00
#$ -N vctk2
#$ -o /gs/hs0/tgh-20IAA/jenn/taco_exp/log/vctk2.out
#$ -e /gs/hs0/tgh-20IAA/jenn/taco_exp/log/vctk2.err
#$ -m e
#$ -p -3
...
# Command to run:
# qsub -g tgh-20IAA tsu_run_vctk2.sh
...
#python preprocess_vqcodes.py --target-only --hparam-json-file=/gs/hs0/tgh-20IAA/jenn/taco_exp/self_attention_tacotron/examples/codes/self-attention-tacotron.json /gs/hs0/tgh-20IAA/jenn/special/L1_dat_files/sys5/vctk_753011/all_vctk /gs/hs0/tgh-20IAA/jenn/taco_exp/data/vctk_target2 2 170
...
TARGET_DATA=/gs/hs0/tgh-20IAA/jenn/taco_exp/data/vctk_target2
CHECKPOINTS=/gs/hs0/tgh-20IAA/jenn/taco_exp/checkpoints/vctk2_small
...
OUTPUT_DIR=/gs/hs0/tgh-20IAA/jenn/taco_exp/prediction/vctk2
...
python postprocess_vqcodes_validation.py vctk2 1000
