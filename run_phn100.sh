...
#SBATCH --job-name=p_text                  # Job name
...
#SBATCH --output=/home/s1738075/taco_modified/logs/phn100_1024_text.out
#SBATCH --error=/home/s1738075/taco_modified/logs/phn100_1024_text.err
...
DATASET=vqcodes
NAME=all_vctk_phn100_SP_text_1024
N=1025
